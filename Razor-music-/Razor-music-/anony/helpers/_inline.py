...
class Inline:
    ...
    def controls(
        ...
        # Sənin istədiyin "Bağla" düyməsi bura əlavə edildi:
        keyboard.append(
            [
                self.ikb(text="Bağla ✖️", callback_data="close_menu")
            ]
        )
    ...
    def song_markup(self, vidid: str) -> types.InlineKeyboardMarkup:
        return self.ikm(
            [
                [
                    self.ikb(text="🎵 Mp3", callback_data=f"song_download mp3 {vidid}"),
                    self.ikb(text="🎥 Video", callback_data=f"song_download video {vidid}"),
                ],
                [
                    self.ikb(text="Bağla ✖️", callback_data="close_menu")
                ]
    ...
    def play_queued(
        ...
        return self.ikm(
            [
                ...
                # "Bağla" düyməsi bura əlavə edildi
                [
                    self.ikb(text="Bağla ✖️", callback_data="close_menu")
                ]
            ]
    ...
    def start_key(
        ...
        rows = [
            [
                self.ikb(text=lang["channel"], url="https://t.me/AzerbaijanBots"),
                self.ikb(text=lang["help"], callback_data="help")
            ],
            [
                self.ikb(
                    text=lang["add_me"],
                    url="https://t.me/RazorMusicBot?startgroup=true",
                )
            ],
            [
                self.ikb(text=lang["owner"], url="https://t.me/ThisMaga"),
                self.ikb(text=lang["ceo"], url="https://t.me/KelleMayallaq"),
            ],
            [
                self.ikb(
                    text=lang["source"],
                    url="https://t.me/s13Musica",
                )
            ]
        ]
